...
bool Game::init()
{
    if (TheRenderWindow::Instance()->init("GAME v1.0", SCREEN_WIDTH, SCREEN_HEIGHT))
    {
        ...
        m_entities.push_back(new Item(new LoaderParams(Vector2f(0, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass1"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(100, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass2"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(200, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass3"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(300, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass4"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(400, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass4"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(500, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass4"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(600, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass4"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(700, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass4"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(800, 620), {0, 0, 100, 100}, m_assets.getTexture("ground_grass4"))));
        m_entities.push_back(new Item(new LoaderParams(Vector2f(0, 0), {0, 0, 1280, 620}, m_assets.getTexture("sky"))));
        m_entities.push_back(new Player(new LoaderParams(Vector2f(0, 0), {0, 0, 200, 200}, m_assets.getTexture("hulking_knight"))));
...
void Game::render()
{
    ...
    TheRenderWindow::Instance()->drawFrame(*m_entities[10]);
