...
bool GameOverState::onEnter()
{
	...
	m_entities.push_back(new AnimatedGraphic(new LoaderParams(Vector2f(200, 345), { 0, 0, 190, 30 }, TheGame::Instance()->getAssets()->getTexture(TextureType::GAME_OVER_TEXT), nullptr), 2));
